...
if(isset($_REQUEST['Submit_val_6']) && $_REQUEST['Submit_val_6'] == 'Confirm'){
...
$getInsertId = $db->insertDataArray(TBL_QUOTS,$arry) or die(mysql_error());
...
$getUpadteId = $db->updateArray(TBL_QUOTS,$arryOne,"id='".$getInsertId."'")or die(mysql_error());
...
$getInsId = $db->insertDataArray(TBL_QUOTS_ACC,$arryTwo) or die(mysql_error());	
if(!empty($getInsId)){
...
$db->updateArray(TBL_QUOTS,$_POST,"id='".$getInsertId."'") or die(mysql_error());	

$sql_packages = "UPDATE ".TBL_QUOTS." SET status=1 WHERE id='".$getInsertId."'";
$rec_packages = $db->updateSql($sql_packages) or die(mysql_error());
...
$name = "New Order From Rent2haul";
$from = 'service@rent2haul.com';
...
<tr>
<td valign='top' style='color:Red'><strong>SUMMARY OF CHARGES</strong></td>
<td></td>
</tr>
<tr>
<td width='20%'><strong>Trailer/Truck Charge:</strong></td>
<td width='80%'> $".$_SESSION['toatlSession']['total']."</td>
</tr>
<tr>
<td width='20%'><strong>Surcharge Charge:</strong></td>
<td width='80%'> $".$_SESSION['surcharge_charge']."</td>
</tr>
<tr>
<td width='20%'><strong>Total Cost:</strong></td>
<td width='80%'><strong> $".stripslashes($_REQUEST['gtotal'])."</strong></td>
</tr>
</table>
<table border='0' align='center' width='100%'>
<tr>
...
<tr>
<td valign='top'><strong>12 Foot Trailer</strong></td>
<td>Qty = ".$get['step_2_product_qty_one'].' Price = '.'$'.$get['step_2_product_price_one']."</td>
</tr>
<tr>
<td valign='top'><strong>16 Foot Trailer</strong></td>
<td>Qty = ".$get['step_2_product_qty_two'].' Price = '.'$'.$get['step_2_product_price_two']."</td>
</tr>
<tr>
<td valign='top'><strong>Pickup</strong></td>
<td>Qty = ".$get['step_2_product_qty_truck'].' Price = '.'$'.$get['step_2_product_price_truck']."</td>
</tr>
<tr>
<td valign='top'><strong>Expedited Service</strong></td>
<td>Qty = ".$get['step_2_product_qty_expedited'].' Price = '.'$'.$get['step_2_product_price_expedited']."</td>
</tr>
<tr>
...
<tr>
<td valign='top'><strong>Total Cost:</strong></td>
<td>$".stripslashes($_REQUEST['gtotal'])."</td>
</tr>
</table>
</body>
</html>";
...
$to = $get['email'];
$subject = "Confirmation Of Your Order From Rent2haul.com";
$message ="
<html>
<head>
...
<body>
<p>Dear customer,</p>
<p>Thanking you for placing the order with RENT2HAUL. Here are the details that you entered when you placed order</p>
...
<tr>
<td width='20%'><strong>Trailer Charge:</strong></td>
<td width='80%'> $".$_SESSION['toatlSession']['total']."</td>
</tr>
<tr>
<td width='20%'><strong>Surcharge Charge:</strong></td>
...
<p>Thanks with best Regards,<br /> Rent2haul Team</p>
</body>
</html>
";
...
header( 'Location: http://www.rent2haul.com/index.php?message=Success:You have successfully contacted with Rent2haul and our team will get back to you with in 8 hours' ) ;
?>
<script type="text/javascript">
window.location.href = 'index.php?message=Success:You have successfully contacted with Rent2haul and our team will get back to you with in 8 hours';
</script>
<?php
}else{
	header( 'Location: http://www.rent2haul.com/index.php?message=Error:Sorry We Have A Temporary Problem !!' ) ;
?>
<script type="text/javascript">
