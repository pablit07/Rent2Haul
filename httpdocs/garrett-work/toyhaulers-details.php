...
<?php $page = $gf->getPageContent(75);
$page_title = $gf->getMetaContent(75);
 ?>
...
<div class="invMain">
<h2><a class="sublNk" href="<?php echo SITE_URL ;?>">Welcome to Freedom Trailers!</a> / <a class="sublNk" href="inventory.php">Inventory</a> / <a class="sublNk" href="toyhaulers.php">Toyhaulers</a> / <?php echo stripslashes($page_title['meta_page_title']);?>  </h2>
