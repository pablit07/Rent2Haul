...
<?php /*?><div class="customersquotLft">
...
<div class="welcomeArea" style="width:100%">
<h3>WELCOME <span>TO Rent2Haul-</span> CALL US FOR A FREE QUOTE <?php echo $adminData['phone']; ?></h3>
<?php echo $page['pages_content'];?>
</div>
</div>
</div>
</div>
<?php /*?><script src="videos/control.js"></script>
