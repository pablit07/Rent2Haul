...
if(!empty($componetArray['image_url'])){ $imagePath = $componetArray['image_url'] ; }else{ $imagePath = 'no.jpg'; }		
?>
<img src="cross.png" width="128" height="128" id="cross" onclick="hide('window')">
