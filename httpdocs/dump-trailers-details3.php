...
<?php $page = $gf->getPageContent(18);
$page_title = $gf->getMetaContent(18);
 ?>
...
<div class="invMain">
<h2>  <a class="sublNk" href="<?php echo SITE_URL ;?>">Welcome to Freedom Trailers!</a> / <a class="sublNk" href="inventory.php">Inventory</a> / <a class="sublNk" href="dump-trailers.php">dump trailers</a>/<?php echo stripslashes($page_title['meta_page_title']);?>  </h2>
