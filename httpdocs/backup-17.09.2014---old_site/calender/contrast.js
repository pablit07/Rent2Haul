...
var gsNavPrev="<A href='javascript:void(0)' class='MonthNav' onclick='if(this.blur)this.blur();fPrevMonth(event);return false;' onmouseover='return true;'><IMG src='arrowl.gif' width='18' height='18' border='0' alt=''></A>";	// the content of the left month navigator
var gsNavNext="<A href='javascript:void(0)' class='MonthNav' onclick='if(this.blur)this.blur();fNextMonth(event);return false;' onmouseover='return true;'><IMG src='arrowr.gif' width='18' height='18' border='0' alt=''></A>";	// the content of the right month navigator

var gbHideBottom=false;	// true: hide the bottom section; false: show it with gsBottom.
var gsBottom=(NN4?"":"<DIV class='BottomDiv'>")+"<A class='Today' href='javascript:void(0)' onclick='if(this.blur)this.blur();fClearSelected();return false;' onmouseover='return true;' title='Clear the selected.'>Clear All</A>"+(NN4?"":"</DIV>");	// the content of the bottom section.
