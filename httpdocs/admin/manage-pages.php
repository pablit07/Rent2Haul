...
<dd><input name="page_name" type="text" class="infoinpt3" id="page_name" value="<?php echo stripcslashes($data['page_name']) ; ?>" /></dd>
</dl>
<dl>
<dt>Page Heading:&nbsp <span class="red">*</span></dt>
<dd><input name="pages_heading" type="text" class="infoinpt3" id="pages_heading" value="<?php echo stripcslashes($data['page_heading']) ; ?>" /></dd>
</dl>
<dl>
...
<textarea name="pages_content" id="pages_content" style="width:700px; height:700px; border:1px solid #999" ><?PHP echo stripcslashes($data['pages_content'])?></textarea>
</dl>
<dl>
<dt>Meta Page Title:&nbsp <span class="red">*</span></dt>
<dd><input name="meta_page_title" type="text" class="infoinpt3" id="meta_page_title" value="<?php echo stripcslashes($data['meta_page_title']) ; ?>" /></dd>
</dl>
<dl>
...
<td height="24" align="center" valign="middle" class="normal_text">&nbsp;&nbsp; <?php echo stripcslashes($row_rec['pages_heading']);?> </td>
<td height="24" align="center" valign="middle" class="normal_text">&nbsp;&nbsp; <?php echo stripcslashes($row_rec['pages_heading']);?> </td>
