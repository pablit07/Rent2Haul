...
<dl>
<dt>Page Name:</dt>
<dd> <b><?php echo stripslashes($row['pages_heading'])?></b> </dd>
</dl>
<dl>
<dt>Page Title:&nbsp <span class="red">*</span></dt>
<dd><input name="meta_page_title" type="text" class="infoinpt8" id="meta_page_title" value="<?php echo stripslashes($row1['meta_page_title']) ; ?>" /></dd>
</dl>
<dl>
