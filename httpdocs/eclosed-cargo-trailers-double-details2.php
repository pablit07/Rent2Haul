...
<?php $page = $gf->getPageContent(50);
$page_title = $gf->getMetaContent(50);
 ?>
...
<div class="invMain">
<h2>  <a class="sublNk" href="<?php echo SITE_URL ;?>">Welcome to Freedom Trailers!</a> / <a class="sublNk" href="inventory.php">Inventory</a> / <a class="sublNk" href="enclosed-cargo-trailers-double.php">ENCLOSED CARGO TRAILERS double door models</a> / <?php echo stripslashes($page_title['meta_page_title']);?>  </h2>
