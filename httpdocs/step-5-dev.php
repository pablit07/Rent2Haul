...
document.location.href='step-4-dev.php';
</script>
<?php
}
?>
...
<form action="step-6-dev.php" method="POST">
...
<p>Purchase 2 from UFirst Moving for $<?php echo $getSA['lock_on_container']; ?>/ea</p>
</div>
<div class="radio2SEc">
<div class="purchaseRadio">
<input name="lock_on_container" type="radio" onClick="getTheSeleted('lock_on_container',0)" value="0" <?php if(isset($_SESSION['pageOneData_four']['lock_on_container']) && $_SESSION['pageOneData_four']['lock_on_container']==0){?> checked="checked" <?php }?> required />
</div>
<p>I will provide</p>
</div>
</div>
...
<div class="countingArea">
<div class="itemTxtArea"><p><?php echo $getSA['equ_one_name']; ?></p></div>
<div class="priceArea"><p>$<?php echo $getSA['equ_one_price']; ?></p></div>
<div class="quantitySec2">
<div class="quanBodr">
...
<div class="itemcolorPrt">
<div class="itemTxtArea"><p><?php echo $getSA['equ_two_name']; ?></p></div>
<div class="priceArea"><p>$<?php echo $getSA['equ_two_price']; ?></p></div>
<div class="quantitySec2"><div class="quanBodr">
