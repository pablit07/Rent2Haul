...
$arry = array(
	...
	"step_2_product_qty_truck" => $_REQUEST['step_2_product_qty_truck'],
	"step_2_product_price_truck" => $_REQUEST['step_2_product_qty_truck']*$_REQUEST['step_2_product_price_one'],
	"expedited-service" => $_REQUEST['expedited-service'],
	"expedited-service-price" => $_REQUEST['expedited-service']*$_REQUEST['step_2_product_price_one']
...
$_SESSION['pageOneData_one']['step_2_product_qty_truck'] = $_REQUEST['step_2_product_qty_truck'];
$_SESSION['pageOneData_one']['step_2_product_price_truck'] = $_REQUEST['step_2_product_price_one']*$_REQUEST['step_2_product_qty_truck'];

$_SESSION['pageOneData_one']['expedited-service'] = $_REQUEST['expedited-service'];
$_SESSION['pageOneData_one']['expedited-service-price'] = $_REQUEST['step_2_product_price_one']*$_REQUEST['expedited-service'];
...
<div class="step3LftPrt col-md-8 col-xs-12" style="margin-bottom:25px;">
<div class="reservationSec col-md-12">
...
<h5>TRUCK RENTAL DATE</h5>
<p>The date you've chosen for your truck rental: <b><?php echo date('m-d-Y',strtotime($_SESSION['pageOneData']['date_to_move'])); ?></b>
<form action="step-5.php" name="" method="post">
<?php }else{ ?>
...
<p>Rent2Haul Moving is designed around your schedule, pack and more importantly unpack at your own pace.
...
<div class="radioprt">
<div class="radiofstprt col-md-12">
...
<div class="scrollarea col-md-12">
...
<div class="step3RightPrt col-md-3 col-xs-12">
<img src="image/moving-banner.jpg" width="100%"/> 
</div>
</div>
</div>
</div>
