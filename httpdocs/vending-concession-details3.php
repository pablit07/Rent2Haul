...
<?php $page = $gf->getPageContent(86);
$page_title = $gf->getMetaContent(86);
 ?>
...
<div class="invMain">
<h2><a class="sublNk" href="<?php echo SITE_URL ;?>">Welcome to Freedom Trailers!</a> / <a class="sublNk" href="inventory.php">Inventory</a> / <a class="sublNk" href="vending-concession.php">Vending and Concession Trailers</a> / <?php echo stripslashes($page_title['meta_page_title']);?>  </h2>
